...
public class DoorActivity extends DeliveryAppBaseActivity
{
    ...
    private void initUberEats()
    {
        ...
        _uberEatsDeliveryDetails = new DoorDeliveryDetails(this, _view.getWebView(), searchAddress);
        _uberEatsMainMenu = new DoorMainMenu(this, _view.getWebView());
        _uberEatsRestaurantMenu = new DoorRestaurantMenu(this, _view.getWebView());
    }
    ...
    {
        DoorMainMenu.Restaurant selectedRestaurant = _uberEatsMainMenu.getSelectedRestaurant();
        DoorRestaurantMenu.FoodItem foodItem = _uberEatsRestaurantMenu.getSelectedFoodItem();
    ...
    private DoorDeliveryDetails _uberEatsDeliveryDetails;
    private DoorMainMenu _uberEatsMainMenu;
    private DoorRestaurantMenu _uberEatsRestaurantMenu;
}
